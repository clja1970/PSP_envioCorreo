...
public class EnvioCorreo
{
	...
	{
		String destinatario = "galanmaquedajoseantonio@gmail.com";
		String asunto = "Correo de prueba enviado desde JAVA_Marchena";
	...
	private static void enviarCorreo(String destinatario, String asunto, String cuerpo)
	{
		...
		try
		{
			...
			transport.close(); System.out.println("Mensaje enviado correctamente!");
		}
